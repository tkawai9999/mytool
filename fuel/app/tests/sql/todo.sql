...
insert into todos(name,start_date,end_date,repeat_flag,repeat_unit_id,repeat_interval,repeat_end_date,status_id,category_id,note,sort_no,delf,created_at,updated_at) values 
